...
const cardStyles = `
    ...
    .card-footer { position: absolute; bottom: 0; width: 100%; height: 32px; background: #e8f5e9; border-top: 1.5px solid #4caf50; display: flex; align-items: center; justify-content: flex-end; padding: 0 10px; box-sizing: border-box; }
    .footer-fsc { font-weight: 900; font-size: 0.95rem; color: #1b5e20; letter-spacing: 0.5px; }
...
function renderCardsOnPage(data) {
    ...
    // STAGE 2: Simplified QR Logic for Print-Scannability (REMOVED FOR NOW)
    /*
    const qrRawData = {
        f: details.fscNo,
        h: details.hof,
